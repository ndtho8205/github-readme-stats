...
const renderWakatimeCard = (stats = {}, options = { hide: [] }) => {
  ...
  card.setCSS(
    `
    ${cssStyles}
    .lang-name { font: 400 11px ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif; fill: ${textColor} }
    `,
  );
